...
async function Animation() {
    const box = chalkAnimation.neon(boxen(`Adventure Game\nProject 07\nBy\nAnas Hakeem`, {
        title: "My Project",
    ...
    if (Player_Name && Player_Password) {
        ...
        if (selectedAction === "Exit") {
            ...
            for (const word of words) {
                ...
                const wordWithoutChar = word.slice(0, indexToRemove) + "_" + word.slice(indexToRemove + 1);
